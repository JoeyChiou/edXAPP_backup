...
import tw.openedu.www.event.CourseAnnouncementEvent;
import tw.openedu.www.logger.Logger;
import tw.openedu.www.util.ResourceUtil;
import tw.openedu.www.view.CourseDetailTabActivity;
    ...
    protected android.app.Notification getNotification(android.content.Context context, android.content.Intent intent) {
        try {
            ...
            if( activity == CourseDetailTabActivity.class ){
                String titleTemplate =  ResourceUtil.getResourceString(tw.openedu.www.R.string.COURSE_ANNOUNCEMENT_NOTIFICATION_TITLE);
                ...
                builder.setSmallIcon(tw.openedu.www.R.drawable.app_icon);
