...
class RegistrationSelectView implements IRegistrationFieldView {
    ...
    public RegistrationSelectView(RegistrationFormField field, View view) {
        ...
        this.mInputView = (RegistrationOptionSpinner) view.findViewById(tw.openedu.www.R.id.input_spinner);
        this.mErrorView = (TextView) view.findViewById(tw.openedu.www.R.id.input_spinner_error);
        this.mInstructionView = (TextView) view.findViewById(tw.openedu.www.R.id.input_spinner_instruction);
    ...
    public boolean isValidInput() {
        ...
        if (mField.isRequired() && !hasValue()) {
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(tw.openedu.www.R.string.error_select_field,
                        mField.getLabel());
            }
