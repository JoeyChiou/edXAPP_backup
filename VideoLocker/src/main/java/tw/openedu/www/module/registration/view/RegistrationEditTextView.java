...
class RegistrationEditTextView implements IRegistrationFieldView {
    ...
    public RegistrationEditTextView(RegistrationFormField field, View view) {
        ...
        this.mInputView = (EditText) view.findViewById(tw.openedu.www.R.id.txt_input);
        this.mErrorView = (TextView) view.findViewById(tw.openedu.www.R.id.txt_input_error);
        this.mInstructionView = (TextView) view.findViewById(tw.openedu.www.R.id.txt_input_instruction);
    ...
    public boolean isValidInput() {
        ...
        if (mField.isRequired() && !hasValue()) {
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(tw.openedu.www.R.string.error_enter_field,
                        mField.getLabel());
            }
        ...
        if (inputLength < mField.getRestriction().getMinLength()) {
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(tw.openedu.www.R.string.error_min_length,
        ...
        if (mField.getRestriction().getMaxLength() > 0
            ...
            if(errorMessage==null || errorMessage.isEmpty()){
                errorMessage = getView().getResources().getString(tw.openedu.www.R.string.error_max_length,
