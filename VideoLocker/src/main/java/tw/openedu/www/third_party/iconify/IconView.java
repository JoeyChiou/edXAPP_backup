package tw.openedu.www.third_party.iconify;
...
public class IconView extends ImageView {
    ...
    public IconView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, tw.openedu.www.R.styleable.IconView, defStyleAttr, 0);
        color = a.getColor(tw.openedu.www.R.styleable.IconView_iconColor, Color.BLACK);
        if (a.hasValue(tw.openedu.www.R.styleable.IconView_iconName)) {
            setIcon(Iconify.IconValue.getFromHashCode(
                    a.getInt(tw.openedu.www.R.styleable.IconView_iconName, -1)));
        }
        a.recycle();
    }
