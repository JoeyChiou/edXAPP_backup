        ...
        try {
            ...
            if(activityContext!=null){
                ...
                Intent targetIntent = Intent.createChooser(email_intent,
                        activityContext.getString(tw.openedu.www.R.string.email_chooser_header));
            ...
            Toast.makeText(activityContext, activityContext.getString(tw.openedu.www.R.string.email_client_not_present),
                    Toast.LENGTH_SHORT)
                    .show();
            logger.error(ex);
        }
