...
public class UiUtil {
    ...
    public static void showMessage(View root, String message){
        ...
        TextView downloadMessageTv = (TextView) root.findViewById(tw.openedu.www.R.id.downloadMessage);
    ...
    public static void showOfflineAccessMessage(View root) {
        ...
        try {
            ViewAnimationUtil.showMessageBar(root.findViewById(tw.openedu.www.R.id.offline_access_panel));
        } catch (Exception e) {
            logger.error(e);
        }
    }
    ...
    public static void hideOfflineAccessMessage(View root) {
        ...
        View v = root.findViewById(tw.openedu.www.R.id.offline_access_panel);
        if (v != null) {
