...
public class FindCoursesBaseActivity extends BaseFragmentActivity
    ...
    protected void onCreate(Bundle arg0) {
        ...
        webview = (WebView) findViewById(tw.openedu.www.R.id.webview);
        offlineBar = findViewById(tw.openedu.www.R.id.offline_bar);
        progressWheel = (ProgressBar) findViewById(tw.openedu.www.R.id.progress_spinner);
    ...
    protected void onStart() {
        super.onStart();
        setTitle(getString(tw.openedu.www.R.string.find_courses_title));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem menuItem = menu.findItem(tw.openedu.www.R.id.progress_download);
    ...
    private void showOfflineMessage(){
        ...
        ETextView offlineModeTv = (ETextView) findViewById(tw.openedu.www.R.id.offline_mode_message);
            ...
            public void onSuccess(Boolean result) {
                ...
                if(result!=null && result) {
                    ...
                    if (course == null || course.getCourse() == null ) {
                        ...
                        msg = String.format("%s", context.getString(tw.openedu.www.R.string.you_are_now_enrolled));
                    }else{
                        // this means, you were already enrolled to this course
                        msg = String.format("%s", context.getString(tw.openedu.www.R.string.already_enrolled));
                    }
    ...
    private void showEnrollErrorMessage(final String courseId, final boolean emailOptIn) {
        if (isActivityStarted()) {
            ...
            dialogMap.put("message_1", getString(tw.openedu.www.R.string.enrollment_failure));

            dialogMap.put("yes_button", getString(tw.openedu.www.R.string.try_again));
