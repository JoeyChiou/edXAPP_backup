...
public class VideoListFragment extends MyVideosBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(tw.openedu.www.R.layout.fragment_video_list, null);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        videoListView = (ListView) getView().findViewById(tw.openedu.www.R.id.list_video);

        if (videoListView != null) {
            isLandscape = false;

            videoListView.setEmptyView(getView().findViewById(
                    tw.openedu.www.R.id.empty_list_view));
            offlineBar = (View) getView().findViewById(tw.openedu.www.R.id.offline_bar);
                ...
                public void onItemClicked(final SectionItemInterface model, final int position) {
                    ...
                    if (model.isDownload()) {
                        ...
                        if ( de.isVideoForWebOnly ){
                            Toast.makeText(getActivity(), getString(tw.openedu.www.R.string.video_only_on_web_short), Toast.LENGTH_SHORT).show();
                        ...
                        if(!de.isDownloaded()){
                            IDialogCallback dialogCallback = new IDialogCallback() {
                                ...
                                public void onNegativeClicked() {
                                    ((VideoListActivity) getActivity()).showInfoMessage(getString(tw.openedu.www.R.string.wifi_off_message));
                                    notifyAdapter();
                                }
                            };
                ...
                public void onItemClicked(SectionItemInterface model,
                    ...
                    if (model.isDownload()) {
                        ...
                        if ( downloadEntry.isVideoForWebOnly ){
                            Toast.makeText(getActivity(), tw.openedu.www.R.string.video_only_on_web_short, Toast.LENGTH_SHORT).show();
                        }
    ...
    private void showPlayer() {
        ...
        try {
            if(getView()!=null){
                View container = getView().findViewById(tw.openedu.www.R.id.container_player);
                if (container != null) {
    ...
    private void hideDeletePanel(View view) {
        try {
            View v = view.findViewById(tw.openedu.www.R.id.delete_button_panel);
            if (v != null) {
    ...
    private void showDeletePanel(View view) {
        try {
            ...
            if (isPlayerVisible()) {
                ...
                view.findViewById(tw.openedu.www.R.id.delete_button_panel).setVisibility(
                        View.VISIBLE);

                deleteButton = (Button) view.findViewById(
                        tw.openedu.www.R.id.delete_btn);
                final Button editButton = (Button) view.findViewById(
                        tw.openedu.www.R.id.edit_btn);
                final Button cancelButton = (Button) view.findViewById(
                        tw.openedu.www.R.id.cancel_btn);
    ...
    public void onConfirmDelete() {
        ...
        if(deletedVideoCount>0){
            try {
                String format = ResourceUtil.getFormattedStringForQuantity(tw.openedu.www.R.plurals.deleted_video,
        ...
        getView().findViewById(tw.openedu.www.R.id.delete_btn).setVisibility(View.GONE);
        getView().findViewById(tw.openedu.www.R.id.edit_btn).setVisibility(View.VISIBLE);
        getView().findViewById(tw.openedu.www.R.id.cancel_btn).setVisibility(View.GONE);
    }
    ...
    protected void showConfirmDeleteDialog(int itemCount) {
        Map<String, String> dialogMap = new HashMap<String, String>();
        dialogMap.put("title", getString(tw.openedu.www.R.string.delete_dialog_title_help));
        dialogMap.put("yes_button", getString(tw.openedu.www.R.string.label_delete));
        dialogMap.put("no_button",  getString(tw.openedu.www.R.string.label_cancel));
        dialogMap.put("message_1", getResources().getQuantityString(tw.openedu.www.R.plurals.delete_video_dialog_msg, itemCount));
