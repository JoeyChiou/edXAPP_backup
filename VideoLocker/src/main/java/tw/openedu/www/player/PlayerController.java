...
public class PlayerController extends FrameLayout {
    ...
    protected View makeControllerView() {
        ...
        mRoot = inflate.inflate(tw.openedu.www.R.layout.player_controller, null);
    ...
    private void initControllerView(View v) {
        ...
        mPauseButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.pause);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(mPauseListener);
        }

        mFullscreenButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.fullscreen);
        if (mFullscreenButton != null) {
            mFullscreenButton.requestFocus();
            mFullscreenButton.setOnClickListener(mFullscreenListener);
        }

        mRewButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.rew);
        if (mRewButton != null) {
        ...
        mNextButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.next);
        if (mNextButton != null && !mFromXml && !mListenersSet) {
            mNextButton.setVisibility(View.GONE);
        }
        mPrevButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.prev);
        if (mPrevButton != null && !mFromXml && !mListenersSet) {
            mPrevButton.setVisibility(View.GONE);
        }

        mProgress = (ProgressBar) v.findViewById(tw.openedu.www.R.id.mediacontroller_progress);
        if (mProgress != null) {
        ...
        mLmsButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.lms_btn);
        if (mLmsButton != null) {
            mLmsButton.requestFocus();
            mLmsButton.setOnClickListener(mLmsClickListener);
        }

        mSettingsButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.settings);
        if (mSettingsButton != null) {
            mSettingsButton.requestFocus();
            mSettingsButton.setOnClickListener(mSettingsListener);
        }

        shareButton = (ImageButton) v.findViewById(tw.openedu.www.R.id.share_btn);
        if (shareButton != null) {
        ...
        mEndTime = (TextView) v.findViewById(tw.openedu.www.R.id.time);
        mCurrentTime = (TextView) v.findViewById(tw.openedu.www.R.id.time_current);
        mFormatBuilder = new StringBuilder();
        mFormatter = new Formatter(mFormatBuilder, Locale.getDefault());

        installPrevNextListeners();

        mTitleTextView = (TextView) v.findViewById(tw.openedu.www.R.id.video_title);
        mTopBar = v.findViewById(tw.openedu.www.R.id.video_top_bar);
    }
    ...
    public void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageResource(tw.openedu.www.R.drawable.ic_pause_button_selector);
        } else {
            mPauseButton.setImageResource(tw.openedu.www.R.drawable.ic_play_button_selector);
        }
    }
    ...
    public void updateFullScreen() {
        ...
        if (mPlayer.isFullScreen()) {
            ...
            mFullscreenButton.setBackgroundResource(tw.openedu.www.R.drawable.ic_fullscreen_exit_selector);
        } else {
            //mFullscreenButton.setImageResource(R.drawable.ic_fullscreen_selector);
            mFullscreenButton.setBackgroundResource(tw.openedu.www.R.drawable.ic_fullscreen_selector);
        }
    }
    ...
    public void setSettingsBtnDrawable(boolean isSettingEnabled){
        if(mSettingsButton!=null){
            if(isSettingEnabled){
                ...
                (tw.openedu.www.R.drawable.ic_media_settings_active);
            }else{
                mSettingsButton.setBackgroundResource
                (tw.openedu.www.R.drawable.ic_media_settings_inactive);
            }   
        }
    }
