...
public class MyRecentVideosFragment extends MyVideosBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(tw.openedu.www.R.layout.fragment_video_list_with_player_container,
                null);
        try{
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try{
            ...
            if (videoListView != null) {
                ...
                videoListView.setEmptyView(getView().findViewById(tw.openedu.www.R.id.empty_list_view));
        ...
        try {
            ...
            if (isResumed() && !isLandscape() && !isRemoving()) {
                ...
                if (containerActivity.playerFragment.isAdded()) {
                    ...
                    ft.replace(tw.openedu.www.R.id.container_player, containerActivity.playerFragment, "player");
                }
                ft.commit();
    ...
    private void hideDeletePanel(View view) {
        try {
            ...
            view.findViewById(tw.openedu.www.R.id.delete_button_panel).setVisibility(View.GONE);
        ...
        try {
            if (!isPlayerVisible()) {
                LinearLayout deletePanel = (LinearLayout) view
                        .findViewById(tw.openedu.www.R.id.delete_button_panel);
                deletePanel.setVisibility(View.VISIBLE);

                deleteButton = (Button) view
                        .findViewById(tw.openedu.www.R.id.delete_btn);
                final Button editButton = (Button) view
                        .findViewById(tw.openedu.www.R.id.edit_btn);
                editButton.setVisibility(View.VISIBLE);
                final Button cancelButton = (Button) view
                        .findViewById(tw.openedu.www.R.id.cancel_btn);
    ...
    private void onConfirmDelete() {
        try{
            ...
            if(deletedVideoCount>0){
                String format =  ResourceUtil.getFormattedStringForQuantity(tw.openedu.www.R.plurals.deleted_video, "video_count", deletedVideoCount).toString();
    ...
    public void setCallback(VideoListFragment.VideoListCallback callback) {
