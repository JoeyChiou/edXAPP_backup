...
public class CCLanguageDialogFragment extends RoboDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(tw.openedu.www.R.layout.panel_cc_popup, container,
                false);
        try{
            ListView lv_ccLang = (ListView) v.findViewById(tw.openedu.www.R.id.cc_list);
            ...
            TextView tvNone = (TextView) v.findViewById(tw.openedu.www.R.id.tv_cc_cancel);
            if(langSelected!=null){
                if(langSelected.equalsIgnoreCase("none")){
                    tvNone.setBackgroundResource(tw.openedu.www.R.color.cyan_text_navigation_20);
                }else{
                    tvNone.setBackgroundResource(tw.openedu.www.R.drawable.white_bottom_rounded_selector);
                }
            }else{
                tvNone.setBackgroundResource(tw.openedu.www.R.color.cyan_text_navigation_20);
            }
