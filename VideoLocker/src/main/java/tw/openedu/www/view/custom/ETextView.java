...
public class ETextView extends TextView {
    ...
    private void processAttrs(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, tw.openedu.www.R.styleable.custom_view, 0, 0);

        try {
            // check for the font attribute and setup font
            String fontFileName = a.getString(tw.openedu.www.R.styleable.custom_view_font);
