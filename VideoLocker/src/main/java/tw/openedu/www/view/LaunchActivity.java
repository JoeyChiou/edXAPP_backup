...
public class LaunchActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(tw.openedu.www.R.layout.activity_launch);
        ...
        if(getIntent().getBooleanExtra(OVERRIDE_ANIMATION_FLAG,false)){
            overridePendingTransition(tw.openedu.www.R.anim.no_transition, tw.openedu.www.R.anim.slide_out_to_bottom);
        }

        //The onTick method need not be run in the LaunchActivity
        runOnTick = false;

        EButton sign_in_tv = (EButton) findViewById(tw.openedu.www.R.id.sign_in_tv);
        ...
        EButton sign_up_button = (EButton) findViewById(tw.openedu.www.R.id.sign_up_btn);
