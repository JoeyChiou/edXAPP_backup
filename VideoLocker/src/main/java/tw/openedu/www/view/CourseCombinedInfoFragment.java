...
import tw.openedu.www.loader.FriendsInCourseLoader;
...
import tw.openedu.www.util.FileUtil;
import tw.openedu.www.util.SocialUtils;
import tw.openedu.www.view.custom.EdxWebView;
import tw.openedu.www.view.custom.SocialAffirmView;
import tw.openedu.www.view.custom.SocialFacePileView;
import tw.openedu.www.view.custom.SocialShareView;
...
public class CourseCombinedInfoFragment extends CourseDetailBaseFragment implements View.OnClickListener, LoaderManager.LoaderCallbacks<AsyncTaskResult<List<SocialMember>>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        certificateContainer = view.findViewById(tw.openedu.www.R.id.combined_course_certificate_container);
        likeButton = (SocialAffirmView) view.findViewById(tw.openedu.www.R.id.course_affirm_btn);

        //Register clicks with the OnClickListener interface
        shareButton = (SocialShareView) view.findViewById(tw.openedu.www.R.id.combined_course_social_share);
        shareButton.setOnClickListener(this);

        TextView handoutText = (TextView) view.findViewById(tw.openedu.www.R.id.combined_course_handout_text);
        View handoutArrow =  view.findViewById(tw.openedu.www.R.id.next_arrow);
        ...
        TextView certificateButton = (TextView) view.findViewById(tw.openedu.www.R.id.view_cert_button);
        certificateButton.setOnClickListener(this);

        facePileContainer = (LinearLayout) view.findViewById(tw.openedu.www.R.id.social_face_pile_container);
        facePileContainer.setOnClickListener(this);

        facePileView = (SocialFacePileView) facePileContainer.findViewById(tw.openedu.www.R.id.combined_course_facepile);

        groupLauncher = (TextView) view.findViewById(tw.openedu.www.R.id.combined_course_social_group);
    ...
    private void loadAnnouncementData(EnrolledCoursesResponse enrollment) {
        ...
        ProgressBar progressBar = (ProgressBar) getView().findViewById(tw.openedu.www.R.id.api_spinner);
    ...
    private void showSocialEnabled(boolean enabled){
        ...
        if (view != null){
            ...
            View loggedInLayout = view.findViewById(tw.openedu.www.R.id.social_layout);
            View groupLinkView = view.findViewById(tw.openedu.www.R.id.combined_course_social_group_container);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case tw.openedu.www.R.id.combined_course_handout_text:
                ...
                break;
            case tw.openedu.www.R.id.view_cert_button:
                if (courseData != null) {
                ...
                break;
            case tw.openedu.www.R.id.combined_course_social_share:
                FacebookProvider fbProvider = new FacebookProvider();
                ...
                break;
            case tw.openedu.www.R.id.social_face_pile_container:
                if (courseData != null) {
                ...
                break;
            case tw.openedu.www.R.id.combined_course_social_group:
