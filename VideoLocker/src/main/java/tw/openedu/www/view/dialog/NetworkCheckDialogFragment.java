...
public class NetworkCheckDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(tw.openedu.www.R.layout.dialog_wifi_confirm,
                container, false);
        ...
        Button positiveButton = (Button) v.findViewById(tw.openedu.www.R.id.positiveButton);
        ...
        Button negativeButton = (Button) v.findViewById(tw.openedu.www.R.id.negativeButton);
