...
public abstract class DownloadEntryAdapter extends BaseListAdapter<DownloadEntry> {
        ...
        if (nativeModel != null) {
            ...
            if (nativeModel.status == DownloadManager.STATUS_FAILED) {
                ...
                holder.error.setText(getContext()
                        .getString(tw.openedu.www.R.string.error_download_failed));

                holder.progress.setProgressDrawable(getContext().getResources()
                        .getDrawable(
                                tw.openedu.www.R.drawable.custom_progress_bar_horizontal_red));
            } else {
                ...
                .setProgressDrawable(getContext()
                        .getResources()
                        .getDrawable(
                                tw.openedu.www.R.drawable.custom_progress_bar_horizontal_green));
            }
        }
    ...
    public BaseViewHolder getTag(View convertView) {
        ...
        holder.title = (TextView) convertView.findViewById(tw.openedu.www.R.id.downloads_name);
