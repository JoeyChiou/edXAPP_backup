...
public class DataUsageDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton(tw.openedu.www.R.string.play_data_dialog_OK, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(tw.openedu.www.R.string.play_data_dialog_Cancel, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dismiss();
            }
