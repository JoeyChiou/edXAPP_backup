...
public class GroupListAdapter extends SimpleAdapter<SocialGroup>  {
    ...
    protected int getRowLayout() {
        return tw.openedu.www.R.layout.group_list_item;
    }
    ...
    protected void setUpView(View view, final SocialGroup item) {
        ...
        if (viewHolder == null) {
            ...
            viewHolder.name = (TextView) view.findViewById(tw.openedu.www.R.id.group_name);
            viewHolder.details = (TextView) view.findViewById(tw.openedu.www.R.id.group_details);
            viewHolder.facePileView = (SocialFacePileView) view.findViewById(tw.openedu.www.R.id.group_list_face_pile);
            viewHolder.unreadDisplay = (TextView) view.findViewById(tw.openedu.www.R.id.group_unread);
        ...
        if (item != null) {
            ...
            if (item.getMembers() == null) {
                ...
                String details = ResourceUtil.getFormattedStringForQuantity(tw.openedu.www.R.string.group_list_members, "members", item.getMembers().size()).toString();
