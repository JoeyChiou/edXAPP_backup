...
public abstract class ChapterAdapter extends BaseListAdapter<SectionEntry> {
    ...
    public ChapterAdapter(Context context, String courseId, IEdxEnvironment environment) {
        super(context, tw.openedu.www.R.layout.row_chapter_list, environment);
    ...
    public void render(BaseViewHolder tag, final SectionEntry model) {
        ...
        if (AppConstants.offline_flag) {
            ...
            {
                holder.next_arrow.setBackgroundResource(tw.openedu.www.R.drawable.ic_next_default_mirrored);
                holder.chapterLayout.setBackgroundResource(tw.openedu.www.R.drawable.list_selector);
                holder.chapterName.setTextColor(getContext().getResources()
                        .getColor(tw.openedu.www.R.color.grey_text_mycourse));
            }else{
                holder.next_arrow
                .setBackgroundResource(tw.openedu.www.R.drawable.ic_next_deactive_mirrored);
                holder.chapterLayout
                        .setBackgroundResource(tw.openedu.www.R.color.disabled_chapter_list);
                holder.chapterName.setTextColor(getContext().getResources()
                        .getColor(tw.openedu.www.R.color.light_gray));
            }
            ...
            holder.chapterName.setTextColor(getContext().getResources().getColor(
                    tw.openedu.www.R.color.grey_text_mycourse));
        }
    }
    ...
    public BaseViewHolder getTag(View convertView) {
        ...
        holder.chapterName = (TextView) convertView
                .findViewById(tw.openedu.www.R.id.chapter_name);
        holder.no_of_videos = (TextView) convertView
                .findViewById(tw.openedu.www.R.id.no_of_videos);
        holder.bulk_download_videos = (LinearLayout) convertView
                .findViewById(tw.openedu.www.R.id.bulk_download_layout);
        holder.next_arrow = (ImageView) convertView
                .findViewById(tw.openedu.www.R.id.next_arrow);
        holder.chapterLayout = (RelativeLayout) convertView
                .findViewById(tw.openedu.www.R.id.chapter_row_layout);
