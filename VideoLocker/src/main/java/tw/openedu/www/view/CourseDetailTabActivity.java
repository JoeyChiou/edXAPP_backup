...
public class CourseDetailTabActivity extends BaseTabActivity {
    ...
    protected List<TabModel> tabsToAdd() {
        ...
        tabs.add(new TabModel(getString(tw.openedu.www.R.string.tab_label_courseware),
                CourseChapterListFragment.class,
                bundle, getString(tw.openedu.www.R.string.tab_chapter_list)));
        tabs.add(new TabModel(getString(tw.openedu.www.R.string.tab_label_course_info),
                CourseCombinedInfoFragment.class,
                bundle, getString(tw.openedu.www.R.string.tab_course_info)));
