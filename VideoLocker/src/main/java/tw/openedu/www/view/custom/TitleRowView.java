...
public class TitleRowView extends LinearLayout {
    ...
    private void setAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray attrArray = context.obtainStyledAttributes(attrs, tw.openedu.www.R.styleable.TitleRowView);
        String title = attrArray.getString(tw.openedu.www.R.styleable.TitleRowView_titleText);
        float fontSize = attrArray.getDimension(tw.openedu.www.R.styleable.TitleRowView_titleFontSize, 12.0f);
        DecorationStyle decorationStyle =DecorationStyle.values()[attrArray.getInt(tw.openedu.www.R.styleable.TitleRowView_decorationStyle, DecorationStyle.CENTER.ordinal())];
        int textColor = attrArray.getColor(tw.openedu.www.R.styleable.TitleRowView_android_textColor, Color.BLACK);
        int leftColor = attrArray.getColor(tw.openedu.www.R.styleable.TitleRowView_leftColor, tw.openedu.www.R.color.grey_act_background);
        int rightColor = attrArray.getColor(tw.openedu.www.R.styleable.TitleRowView_rightColor, tw.openedu.www.R.color.grey_act_background);
