...
public class ResetPasswordDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(tw.openedu.www.R.layout.fragment_dialog, container, false);
        // Watch for button clicks.
        email_et = (EditText) v.findViewById(tw.openedu.www.R.id.email_edit);
        error = (TextView) v.findViewById(tw.openedu.www.R.id.dialog_error_message);
        progressbar = (ProgressBar) v.findViewById(tw.openedu.www.R.id.login_spinner);
        resetLayout = (RelativeLayout) v.findViewById(tw.openedu.www.R.id.reset_layout);

        Button positiveBtn = (Button) v.findViewById(tw.openedu.www.R.id.positiveButton);
            ...
            public void onClick(View v) {
                ...
                if (!NetworkUtil.isConnected(getActivity())) {
                    ...
                    error.setText(getResources().getString(
                            tw.openedu.www.R.string.network_not_connected_short));
        ...
        Button negativeBtn = (Button) v.findViewById(tw.openedu.www.R.id.negativeButton);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        TextView title = (TextView) getView()
                .findViewById(tw.openedu.www.R.id.tv_dialog_title);
        TextView message = (TextView) getView().findViewById(
                tw.openedu.www.R.id.tv_dialog_message1);
        title.setText(getResources().getString(
                tw.openedu.www.R.string.confirm_dialog_title_help));
        message.setText(getResources().getString(
                tw.openedu.www.R.string.confirm_dialog_message_help));
