...
public class CourseDashboardActivity extends CourseBaseActivity implements CourseDashboardFragment.ShowCourseOutlineCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  configureDrawer();
        ...
        try{
            environment.getSegment().screenViewsTracking(getString(tw.openedu.www.R.string.course_home));
        }catch(Exception e){
            logger.error(e);
        }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            try {
                ...
                fragmentTransaction.add(tw.openedu.www.R.id.fragment_container, fragment);
    ...
    public void showCourseOutline() {
        ...
        getHierarchyTask = new GetCourseStructureTask(this, courseData.getCourse().getId()) {
            ...
            public void onException(Exception ex) {
                isTaskRunning = false;
                showInfoMessage(getString(tw.openedu.www.R.string.no_connectivity));
            }
        };
