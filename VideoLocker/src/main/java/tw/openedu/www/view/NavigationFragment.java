...
public class NavigationFragment extends RoboFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(tw.openedu.www.R.layout.drawer_navigation, null);

        TextView name_tv = (TextView) layout.findViewById(tw.openedu.www.R.id.name_tv);
        TextView email_tv = (TextView) layout.findViewById(tw.openedu.www.R.id.email_tv);

        TextView tvMyCourses = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_my_courses);
        ...
        TextView tvMyVideos = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_my_videos);
        tvMyVideos.setOnClickListener(new OnClickListener() {
            ...
            TextView tvFindCourses = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_find_courses);
        ...
        TextView tvMyGroups = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_my_groups);
        ...
        TextView tvSettings = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_my_settings);
        ...
        TextView tvSubmitFeedback = (TextView) layout.findViewById(tw.openedu.www.R.id.drawer_option_submit_feedback);
        tvSubmitFeedback.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String to = environment.getConfig().getFeedbackEmailAddress();
                String subject = getString(tw.openedu.www.R.string.email_subject);
                String email = "";
        ...
        Button logout_btn = (Button) layout.findViewById(tw.openedu.www.R.id.logout_button);
        ...
        TextView version_tv = (TextView) layout.findViewById(tw.openedu.www.R.id.tv_version_no);
        try{
            ...
            if(versionName != null) {
                ...
                String text = String.format("%s %s %s",
                        getString(tw.openedu.www.R.string.label_version), versionName, envDisplayName);
    ...
    public void onResume() {
        ...
        if (getView() != null){
            View groupsItemView = getView().findViewById(tw.openedu.www.R.id.drawer_option_my_groups);
            ...
            View findCoursesItemView = getView().findViewById(tw.openedu.www.R.id.panel_option_find_courses);
    ...
    private void updateWifiSwitch(View layout) {
        ...
        Switch wifi_switch = (Switch) layout.findViewById(tw.openedu.www.R.id.wifi_setting);
    ...
    protected void showWifiDialog() {
        newFragment = NetworkCheckDialogFragment.newInstance(getString(tw.openedu.www.R.string.wifi_dialog_title_help), getString(tw.openedu.www.R.string.wifi_dialog_message_help), new IDialogCallback() {
            @Override
