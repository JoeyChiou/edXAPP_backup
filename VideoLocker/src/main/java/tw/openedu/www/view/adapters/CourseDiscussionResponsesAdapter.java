...
import tw.openedu.www.discussion.DiscussionThreadFollowedEvent;
import tw.openedu.www.task.FlagCommentTask;
import tw.openedu.www.task.FlagThreadTask;
import tw.openedu.www.task.FollowThreadTask;
import tw.openedu.www.task.VoteCommentTask;
import tw.openedu.www.task.VoteThreadTask;
...
public class CourseDiscussionResponsesAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == RowType.THREAD) {
            View discussionThreadRow = LayoutInflater.
                    ...
                    inflate(tw.openedu.www.R.layout.discussion_responses_thread_row, parent, false);
        ...
        if (viewType == RowType.MORE_BUTTON) {
            View discussionThreadRow = LayoutInflater.
                    from(parent.getContext()).
                    inflate(tw.openedu.www.R.layout.show_more_button_row, parent, false);
        ...
        View discussionResponseRow = LayoutInflater.
                from(parent.getContext()).
                inflate(tw.openedu.www.R.layout.discussion_responses_response_row, parent, false);
    ...
    private void bindNumberResponsesView(NumberResponsesViewHolder holder) {
        holder.numberResponsesOrCommentsLabel.setText(context.getResources().getQuantityString(
                tw.openedu.www.R.plurals.number_responses_or_comments_responses_label, discussionThread.getCommentCount(), discussionThread.getCommentCount()));
    }
    ...
    private void bindNumberCommentsView(NumberResponsesViewHolder holder, DiscussionComment response) {
        ...
        if (numChildren == 0) {
            holder.numberResponsesOrCommentsLabel.setText(context.getString(
                    tw.openedu.www.R.string.number_responses_or_comments_add_comment_label));
        } else {
            holder.numberResponsesOrCommentsLabel.setText(context.getResources().
                    getQuantityString(tw.openedu.www.R.plurals.number_responses_or_comments_comments_label, numChildren, numChildren));
        }
    }
    ...
    public static class ShowMoreViewHolder extends RecyclerView.ViewHolder {
        ...
        public ShowMoreViewHolder(View itemView) {
            ...
            showMoreView = (ETextView) itemView.
                    findViewById(tw.openedu.www.R.id.show_more_button);
        }
    }
    ...
    public static class DiscussionThreadViewHolder extends RecyclerView.ViewHolder {
        ...
        public DiscussionThreadViewHolder(View itemView) {
            ...
            threadTitleTextView = (ETextView) itemView.
                    findViewById(tw.openedu.www.R.id.discussion_responses_thread_row_title_text_view);
            threadBodyTextView = (ETextView) itemView.
                    findViewById(tw.openedu.www.R.id.discussion_responses_thread_row_body_text_view);
            threadPinnedIconView = (IconView) itemView.
                    findViewById(tw.openedu.www.R.id.discussion_responses_thread_row_pinned_icon_view);
    ...
    public static class DiscussionResponseViewHolder extends RecyclerView.ViewHolder {
        ...
        public DiscussionResponseViewHolder(View itemView) {
            ...
            addCommentLayout = (RelativeLayout) itemView.findViewById(tw.openedu.www.R.id.discussion_responses_comment_relative_layout);
            responseCommentBodyTextView = (ETextView) itemView.findViewById(tw.openedu.www.R.id.discussion_responses_comment_body_text_view);
            authorLayoutViewHolder = new AuthorLayoutViewHolder(itemView);
            numberResponsesViewHolder = new NumberResponsesViewHolder(itemView);
            socialLayoutViewHolder = new DiscussionSocialLayoutViewHolder(itemView);
            discussionReportViewHolder = new DiscussionReportViewHolder(itemView);
