...
public class CourseDiscussionCommentsFragment extends RoboFragment implements DiscussionCommentsAdapter.Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(tw.openedu.www.R.layout.fragment_discussion_comments, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final int overlap = getResources().getDimensionPixelSize(tw.openedu.www.R.dimen.edx_hairline);
        ...
        createNewCommentTextView.setText(context.getString(tw.openedu.www.R.string.discussion_post_create_new_comment));
